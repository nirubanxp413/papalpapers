...
Perform bulk operations on your [HTML document](<https://htmlg.com/html-editor/>) on any HTML tag. Choose to replace, delete the whole block, delete only the tag or delete the tag attributes only of the selected tags.